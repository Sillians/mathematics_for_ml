...
Let $`\mathbf{X} \sim \mathcal{N}_n(\boldsymbol{\mu}, \boldsymbol{\Sigma})`$, and let $`\mathbf{a} \in \mathbb{R}^n`$. Define:
...
* $`Z \sim \mathcal{N}(\mathbf{a}^\top \boldsymbol{\mu},\ \mathbf{a}^\top \boldsymbol{\Sigma} \mathbf{a})`$
...
| Multivariate Linear | $`\mathbf{a}^\top \mathbf{X} \sim \mathcal{N}(\mathbf{a}^\top \boldsymbol{\mu},\ \mathbf{a}^\top \boldsymbol{\Sigma} \mathbf{a})`$ |                                                                                                      |
